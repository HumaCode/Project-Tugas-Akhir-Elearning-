...
class Chat extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('chating/v_index', $data);
    }
    ...
    public function kirim()
    {
        ...
        return view('chating/v_kirim', $data);
    }
    ...
    public function pesanKeluar()
    {
        ...
        return view('chating/v_pesan-keluar', $data);
    }
    ...
    public function pesanMasuk()
    {
        ...
        return view('chating/v_pesan-masuk', $data);
    }
    ...
    public function lihatInbox($id_chating)
    {
        ...
        return view('chating/v_pesan-masuk-detail', $data);
    }
    ...
    public function lihat($id_chating)
    {
        ...
        return view('chating/v_pesan-keluar-detail', $data);
    }
