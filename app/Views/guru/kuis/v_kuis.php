    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="<?= base_url('guru/tambahKuis/' . $id_sub_kursus . '/' . $id_kursus) ?>" type="button" class="btn bg-cyan btn-flat btn-xs"><i class="fas fa-plus"></i> &nbsp;Tambah</a>
            </div>
        </div>
        <div class="card-body">
