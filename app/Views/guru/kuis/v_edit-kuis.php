...
<div class="col-sm-12">
    <div class="card card-outline card-cyan">
        ...
        <div class="card-body">
            ...
            <?= form_open_multipart('guru/prosesEditKuis') ?>
            <?= csrf_field() ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_kuis" id="nama_kuis" class="form-control form-control-sm <?= $validation->hasError('nama_kuis') ? 'is-invalid' : '' ?>" style="border-radius: 0px;" value="<?= $kuis['nama_kuis'] ?>">
            ...
            <div class="form-group">
                ...
                <select name="pertemuan" id="pertemuan" class="form-control form-control-sm <?= $validation->hasError('pertemuan') ? 'is-invalid' : '' ?>" style="border-radius: 0px;">
                    ...
                    <?php for ($i = 1; $i <= 12; $i++) : ?>
                        <option value="<?= $i ?>" <?= ($kuis['pertemuan'] == $i) ? 'selected' : '' ?>><?= $i ?></option>
                    <?php endfor; ?>
            ...
            <div class="form-group">
                ...
                <textarea name="kuis" id="kuis"><?= $kuis['kuis'] ?></textarea>
            ...
            <div class="form-group" id="vv" <?php if ($kuis['url'] == null) {
                                                echo "style= 'display: none;'";
                                            } else {
                                                echo "style= 'display: revert;'";
                                            }  ?>>
                <label for="url">Id Video</label>
                <input type="text" name="url" class="form-control" value="<?= $kuis['url'] ?>">
            </div>
        ...
        <div class="card-footer">
            <a href="<?= base_url('guru/kuis/' . $id_sub_kursus . '/' . $id_kursus) ?>" class="btn btn-flat btn-block btn-danger">Kembali</a>
        </div>
    </div>
</div>
