    ...
    <div class="card card-cyan card-outline">
        ...
        <div class="card-body">
            <div class="mailbox-controls">
                ...
                <?= form_open('guru/proses_kirim', ['class' => 'formKirim']) ?>
                <?= csrf_field() ?>
...
<div class="col-md-8">
    <div class="card card-cyan card-outline">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <a href="<?= base_url('guru/chat') ?>" class="btn btn-danger btn-flat btn-sm"><i class="fa fa-arrow-left"></i> &nbsp;Kembali</a>
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = '<?= base_url('guru/pesanKeluar') ?>';
                        })
