...
<div class="col-md-12">
    <div class="card card-outline card-cyan">
        ...
        <div class="card-body">
            ...
            <?= form_open_multipart('guru/prosesTambahMateri') ?>
            <?= csrf_field() ?>
            ...
            <button type="button" class="btn btn-xs btn-flat btn-danger" id="bt">Batal</button> <button type="button" class="btn btn-xs" data-toggle="modal" data-target="#info"><i class="fas fa-info-circle"></i></button>
            ...
            <div class="form-group" id="vv" style="display: none;">
                <label for="url">Id Video</label>
                <input type="text" name="url" class="form-control" placeholder="Id Youtube">
            </div>
        ...
        <div class="card-footer">
            <a href="<?= base_url('guru/materi/' . $id_sub_kursus . '/' . $id_kursus) ?>" class="btn btn-danger btn-block">Kembali</a>
        </div>
    </div>
</div>
