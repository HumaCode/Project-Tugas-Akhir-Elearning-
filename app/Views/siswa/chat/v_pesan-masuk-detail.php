...
<div class="col-md-12">
    <div class="card card-cyan card-outline">
        ...
        <div class="card-body ">
            ...
            <hr>
            <?= form_open('chatSiswa/balasPesan', ['class' => 'formBalas']) ?>
            <?= csrf_field() ?>
        ...
        <div class="card-footer">
            <a href="<?= base_url('chatSiswa/pesanMasuk') ?>" class="btn btn-danger btn-sm btn-block btn-flat">Kembali</a>
        </div>
    </div>
</div>
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = '<?= base_url('chatSiswa/pesanKeluar') ?>';
                        })
