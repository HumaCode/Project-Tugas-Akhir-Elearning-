...
<div class="col-md-12">
    <div class="card card-outline card-cyan">
        ...
        <div class="card-body ">
            ...
            <?= form_open('admin/hapusAnggota', ['class' => 'formHapusBanyak']) ?>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <?php if (empty($anggota)) { ?>
                        ...
                        <tr>
                            <td colspan="4" class="text-center text-danger">Belum ada anggota</td>
                        </tr>
        ...
        <div class="card-footer">
            <a href="<?= base_url('admin/subKursus/' . $id_kursus) ?>" class="btn btn-sm btn-danger btn-flat btn-block">Kembali</a>
        </div>
    </div>
</div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" class="btn btn-danger btn-xs btn-fla" data-dismiss="modal"><i class="fa fa-ban"></i> &nbsp;Batal</button>
                    <button type="submit" class="btn btn-success btn-xs btn-flat"><i class="fa fa-edit"></i> &nbsp;Ubah</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.update-record').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo site_url('admin/tampilAnggotaByIdKursus'); ?>",
                method: "POST",
                data: {
                    id_kursus: id_kursus
                },
        ...
        $('.formHapusBanyak').submit(function(e) {
            ...
            if (jmlData.length === 0) {
                ...
                Swal.fire({
                    ...
                    text: `Apakah yakin akan menghapus ${jmlData.length} data anggota..?`,
                    icon: 'warning',
    ...
    function tambah(id_kursus) {
        $.ajax({
            type: "post",
            url: "<?= site_url('admin/formTambahAnggota') ?>",
            data: {
                id_kursus: id_kursus
            },
            dataType: "json",
