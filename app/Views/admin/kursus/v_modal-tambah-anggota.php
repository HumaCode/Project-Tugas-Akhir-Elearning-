<div class="modal fade" id="modalTambahAnggota">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open('admin/simpanAnggotaKelas/' . $id_kursus, ['class' => 'formAnggota']) ?>
            <?= csrf_field() ?>
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="submit" class="btn bg-cyan btn-xs btn-flat"><i class="fas fa-save"></i> &nbsp;Tambah</button>
            </div>
            <?= form_close() ?>
        </div>
    </div>
