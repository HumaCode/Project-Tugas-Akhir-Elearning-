...
<div class="col-md-12">
    <div class="card card-outline card-cyan">
        <div class="card-header">
            <h3 class="card-title">Matapelajaran</h3>
...
<script>
    ...
    function dataMapel() {
        $.ajax({
            url: "<?= site_url('admin/ambilDataMapel') ?>",
            dataType: "json",
    ...
    $(document).ready(function() {
        dataMapel(); // menampilkan data Mapel
        ...
        $('.tombol-tambah').click(function(e) {
            ...
            $.ajax({
                url: "<?= site_url('admin/formTambahMapel') ?>",
                dataType: "json",
                success: function(response) {
        ...
        $('.tombol-tambah-banyak').click(function(e) {
            ...
            $.ajax({
                url: "<?= site_url('admin/formTambahMapelBanyak') ?>",
                dataType: "json",
                beforeSend: function() {
