<div class="modal fade" id="modalTambah">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open('admin/simpanMapel', ['class' => 'formMapel']) ?>
            <?= csrf_field() ?>
            <div class="modal-body">
                <div class="form-group">
                    <label for="mapel">Matapelajaran</label>
                    <input type="text" class="form-control form-control-sm" style="border-radius: 0px;" name="mapel" id="mapel" placeholder="Masukan Matapelajaran">
